...
const defaultPools = {
    person: [
        ...
        'Notion人生管理者', 'Obsidian第二大脑建设者', '读博还是创业纠结者', '语言羞耻者', '东亚小孩'
    ],
    event: [
    ...
    choice: [
        ...
        '自我叙事重构', '建立个人品牌', '输出LinkedIn精英内容', '在X上发布暴论', '制作YouTube长视频',
        '收听播客疗愈', '购买知识付费课程', '学习AI副业技巧', '使用Notion人生管理', '构建Obsidian第二大脑'
    ]
};
...
const titleTemplates = [
    ...
    '《当{person}遇见{event}，选择了{choice}》',
    '《30岁开始做{choice}，为了逃离{event}》',
    '《{person}和他的{event}》',
    '《{event}里的{person}，不浪漫，也不幻想》',
    '《{choice}，和{person}背后的{event}》',
    '《我在{event}的60天：{person}，{choice}》',
    '《{event}之后，一个{person}的{choice}》',
